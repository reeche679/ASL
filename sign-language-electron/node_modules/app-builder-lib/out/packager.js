...
class Packager {
    ...
    async callArtifactBuildStarted(event, logFields) {
        ...
        const handler = (0, platformPackager_1.resolveFunction)(this.config.artifactBuildStarted, "artifactBuildStarted");
        if (handler != null) {
    ...
    async callArtifactBuildCompleted(event) {
        const handler = (0, platformPackager_1.resolveFunction)(this.config.artifactBuildCompleted, "artifactBuildCompleted");
        if (handler != null) {
            await Promise.resolve(handler(event));
        }
    ...
    async callAppxManifestCreated(path) {
        const handler = (0, platformPackager_1.resolveFunction)(this.config.appxManifestCreated, "appxManifestCreated");
        if (handler != null) {
            await Promise.resolve(handler(path));
        }
    }
    async callMsiProjectCreated(path) {
        const handler = (0, platformPackager_1.resolveFunction)(this.config.msiProjectCreated, "msiProjectCreated");
        if (handler != null) {
            await Promise.resolve(handler(path));
        }
    }
    ...
    async installAppDependencies(platform, arch) {
        ...
        const beforeBuild = (0, platformPackager_1.resolveFunction)(config.beforeBuild, "beforeBuild");
        if (beforeBuild != null) {
    ...
    async afterPack(context) {
        const afterPack = (0, platformPackager_1.resolveFunction)(this.config.afterPack, "afterPack");
